...
alias ligar-radio='cd ~/minha-radio && node server.js & cloudflared tunnel --url http://localhost:3000 2>&1 | grep --line-buffered -o "https://[a-zA-Z0-9-]*\.trycloudflare\.com" | while read url; do clear; echo -e "
========================================
